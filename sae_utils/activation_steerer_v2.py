...
class ActivationSteeringV2:
    ...
    def __init__(
        ...
        *,
        ...
        if self.debug:
            print(f"[ActivationSteeringV2] Initialized with:")
    ...
    def _get_layer_module(self, layer_idx):
        ...
        if self.debug:
            print(f"[ActivationSteeringV2] Located layer {path}[{layer_idx}]")
    ...
    def _apply_layer_interventions(self, activations, layer_idx):
        ...
        for vector, coeff, vector_idx in self.vectors_by_layer[layer_idx]:
            ...
            if self.debug:
                ...
                print(f"[ActivationSteeringV2] Layer {layer_idx}, vector {vector_idx}: "
    ...
    def __enter__(self):
        ...
        if self.debug:
            print(f"[ActivationSteeringV2] Registered {len(self._handles)} hooks on layers {sorted(self.vectors_by_layer.keys())}")
    ...
    def remove(self):
        ...
        if self.debug:
            print("[ActivationSteeringV2] Removed all hooks")
